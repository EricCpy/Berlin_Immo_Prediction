...
1. **Full Tree:** Surprisingly, the full tree performs well on the test dataset, achieving competitive results in MSE and RMSE and the best results for mean absolute erro. This suggests a high degree of variance in the dataset.  
