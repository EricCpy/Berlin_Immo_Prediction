...
- **eta** (0.01, 0.05, **0.1**, 0.3, 0.5)  
  The learning rate, which controls the contribution of each tree. A smaller eta can lead to better generalization but requires more trees to achieve convergence.
